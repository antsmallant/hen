--modify from : https://github.com/caogtaa/skynet-qp-server.git
...
--[[
    ...
    print(table.tunpack(t))
    print: k1, v1, k2, v2
    print(table.tunpack(t, true))
    print: { k1, v1, k2, v2 }
]]
table.tunpack = function(t, nounpack)
    local data = {}
	for k, v in pairs(t) do
		table.insert(data, k)
		table.insert(data, v)
